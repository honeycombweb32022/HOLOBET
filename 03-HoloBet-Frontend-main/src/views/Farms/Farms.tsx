...
const StyledImage = styled(Image)`
  ...
  margin-top: 58px;
`
const NUMBER_OF_FARMS_VISIBLE = 2
          ...
          <ViewControls>
            ...
            <ToggleWrapper>
              <Toggle
                ...
                scale="sm"
              />
              <Text style={{color:'#FFFFFF'}}> {t('Staked only')}</Text>
            </ToggleWrapper>
            <FarmTabButtons hasStakeInFinishedFarms={stakedInactiveFarms.length > 0} />
          </ViewControls>
          <FilterContainer>
            <LabelWrapper>
              <Text textTransform="uppercase" style={{color:'#FFFFFF'}}>{t('Sort by')}</Text>
              <Select
                options={[
                  {
                    label: t('Hot'),
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <Text textTransform="uppercase" style={{color:'#FFFFFF'}}>{t('Search')}</Text>
