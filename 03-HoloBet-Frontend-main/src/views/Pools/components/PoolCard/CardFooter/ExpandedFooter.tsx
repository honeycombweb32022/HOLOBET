  ...
  return (
    <ExpandedWrapper flexDirection="column">
      ...
      <Flex mb="2px" justifyContent="space-between" alignItems="center">
        ...
        <Flex alignItems="flex-start">
          {totalStaked && totalStaked.gte(0) ? (
            <>
              <Balance color="textSubtle" small value={getTotalStakedBalance()} decimals={0} unit={` ${stakingToken.symbol}`} />
          ...
          {blocksRemaining || blocksUntilStart ? (
            <Flex alignItems="center">
              <Link external href={getBscScanLink(hasPoolStarted ? endBlock : startBlock, 'countdown')}>
                <Balance small  value={blocksToDisplay} decimals={0} color="textSubtle" />
                <Text  small ml="4px" color="textSubtle" textTransform="lowercase">
                  {t('Blocks')}
                </Text>
      ...
      <Flex mb="2px" justifyContent="flex-end">
        <LinkExternal color='textSubtle' href={`/info/token/${earningToken.address}`} bold={false} small>
          {t('See Token Info')}
        </LinkExternal>
      </Flex>
      <Flex mb="2px" justifyContent="flex-end">
        <LinkExternal href={earningToken.projectLink} bold={false} small color='textSubtle'>
          {t('View Project Site')}
        </LinkExternal>
      </Flex>
      {poolContractAddress && (
