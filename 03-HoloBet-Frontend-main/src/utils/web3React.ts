...
const portisConnector = new PortisConnector({ dAppId: 'ac44d1d1-d04c-447d-b788-23ae1efdd72a', networks:[1,4],   })

const torusConnector = new TorusConnector({chainId})

export const connectorsByName = {
  [ConnectorNames.Injected]: injected,
  [ConnectorNames.WalletConnect]: walletconnect,
  [ConnectorNames.BSC]: bscConnector,
  [ConnectorNames.Portis]: portisConnector,
  [ConnectorNames.Torus]: torusConnector,
