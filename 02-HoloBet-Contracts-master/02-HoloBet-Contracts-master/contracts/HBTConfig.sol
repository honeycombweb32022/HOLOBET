...
contract HBTConfig is Ownable, IHBTConfig {
    ...
    uint256 public override feePercent; // 10: 1%, 15: 1.5%, 50: 5%

    constructor(
        IHolobetSwapPair _pair,
        IStaking _staking,
        ILPMining _lpMining,
        IERC20 _baseToken,
        uint256 _baseAmount,
